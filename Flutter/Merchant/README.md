...
For more details on the native integration process, refer to the [Android SDK](https://docs.minkasupay.com/Minkasu_2FA_SDK_Merchant_Integration_Android_v5.0.0.pdf) and [iOS SDK](https://github.com/mk-it-admin/Minkasu2FA_SampleApp/tree/iOS_v5.0.0/iOS/Merchant) documentation.
...
1.  **Flutter Configurations**
    ...
    2. Create a `Minkasu2FAConfig` object 
        ...
        ```
    3. Create a callback function to receive updates from `Minkasu2FA`. Refer to the [Android](https://docs.minkasupay.com/Minkasu_2FA_SDK_Merchant_Integration_Android_v5.0.0.pdf) and [iOS](https://github.com/mk-it-admin/Minkasu2FA_SampleApp/tree/iOS_v5.0.0/iOS/Merchant) documentation for more details about the payload.
        ```dart
...
2. **Android Configurations**
    ...
    1. Add the `Minkasu2FA` dependency to the `build.gradle.kts` file located at `android/app`:
        ...
        dependencies {
            // other dependencies
            implementation("com.minkasu:minkasu-2fa:5.0.0") // Add the Minkasu2FA dependency here
        }
        ```
...
3. **iOS Configurations**
    1. Add `NSFaceIDUsageDescription` to `Info.plist`
        ...
        ```
    2. Update the Podfile located at ios/Podfile to:
        1. Ensure the project supports iOS 13.0 or higher.
        2. Add the `Minkasu2FA` dependency
            ...
            target 'Runner' do
                use_frameworks!
                pod 'Minkasu2FA', '5.0.0'  # Add Minkasu2FA dependency here
