...
- (void)initSDKwithWebView:(WKWebView *)webView
    ...
    NSError *error = nil;
    [Minkasu2FA initWithWKWebView:webView
...
- (Minkasu2FAConfig *)constructConfigFrom:(NSDictionary *)configDictionary {
    ...
    NSDictionary *partnerInfoDictionary = configDictionary[@"partnerInfo"];
    Minkasu2FAPartnerInfo *partnerInfo = [self constructPartnerInfoFrom:partnerInfoDictionary];
...
- (Minkasu2FAPartnerInfo *)constructPartnerInfoFrom:
(NSDictionary *)partnerInfoDictionary {
    NSString *merchantId = partnerInfoDictionary[@"merchantId"];
    NSString *merchantName = partnerInfoDictionary[@"merchantName"];
    NSString *transactionId = partnerInfoDictionary[@"transactionId"];
    ...
    if (transactionId && transactionId != nil &&
        ![transactionId isKindOfClass:[NSNull class]]) {
