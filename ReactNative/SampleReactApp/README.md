...
```
$ npm install --save mk-it-admin/react-native-webview.git#Minkasu2FA_v4.2.13161
```
or
```
$ yarn add react-native-webview@https://github.com/mk-it-admin/react-native-webview#Minkasu2FA_v4.2.13161
``` 
