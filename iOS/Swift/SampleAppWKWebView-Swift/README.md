...
1.Conforming to Minkasu2FACallbackDelegate Protocol on your ViewController class which initialize Minkasu2FA iOS SDK. ```Minkasu2FACallbackDelegate``` <br>
2.Setting the delegate in Minkasu2FA config. ``` config.delegate = self``` <br>
3.Implementing Minkasu2FACallback delegate method.<br>
