...
1.Conforming to Minkasu2FACallbackDelegate Protocol on your ViewController class which initializes Minkasu2FA iOS SDK. ```<Minkasu2FACallbackDelegate>```<br>
2.Setting the delegate in Minkasu2FAConfig. ``` config.delegate = self;```<br>
