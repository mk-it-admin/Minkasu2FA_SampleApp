...
| data  | NSDictionary  | If infoType is RESULT, the following Dictionary is returned:"reference_id", "status", "auth_type", "source", "code""message".
If infoType is EVENT, the following Dictionary will be returned:"reference_id","screen","event".|
