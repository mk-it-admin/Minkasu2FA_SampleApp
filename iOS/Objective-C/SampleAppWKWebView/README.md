...
| data                 | NSDictionary       | If infoType is RESULT, the following Dictionary is returned:{<br>  "reference_id": (NSString *)<minkasu_transaction_ref>, <br>  "status”      : (NSString *)<SUCCESS\|FAILED\| TIMEOUT\|CANCELLED\|DISABLED>",<br>  "source"      : (NSString *)<PayPin\|Fingerprint\|Face>", <br>  "source"      : (NSString *)<SDK\|SERVER\|BANK>", <br>  "code"        : (NSInteger)<result/error_code>, <br>                  0    – Success<br>                  5001 - Phone number mismatch<br>                  5500 - Screen   close<br>                  5501 - Forgot PayPIN;<br>                  6508 - PayPIN   attempts exceed<br>                  6514 - Setup   code timeout<br>                  6515 - OTP   attempts exceeded<br>                  6518 - Insufficient   balance     <br>  "message"     : (NSString *)<result/error_message> // See above messages<br>}<br>   <br>If infoType is EVENT, the following Dictionary will be returned:{<br>  "reference_id": (NSString *)<minkasu_transaction_ref>,<br>  "screen"      : (NSString *)<FTU_SETUP_CODE_SCREEN\|FTU_AUTH_SCREEN\|REPEAT_AUTH_SCREEN>,<br>  "event"       : (NSString *)<ENTRY><br>} |
|                      |    <br>            |    <br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
